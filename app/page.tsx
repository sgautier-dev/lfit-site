	...
	return (
		<main className="mx-auto min-h-screen font-judson">
			<div className="relative xl:mx-auto xl:max-w-7xl xl:px-8 ">
				...
				<div className="grid lg:grid-cols-2 items-start pt-32 px-20 gap-x-8">
					<Image
					...
					<div className="bg-white/80 rounded-xl p-6">
						...
						<button
							type="button"
							className="mt-4 rounded-md bg-pinkCust px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-pinkCust/80 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-pinkCust/80"
						>
							Me Contacter
						</button>
					</div>
