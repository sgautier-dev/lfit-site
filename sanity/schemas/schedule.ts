          ...
          fields: [
            {
              ...
              validation: Rule => Rule.custom((time: string) => {
            ...
            },
            {
                ...
                options: {
                  list: [
                    ...
                    { title: 'Stretching', value: '/images/icons8-stratching-30.png' },
                    { title: 'Yogalates', value: '/images/icons8-yoga-30.png' },
                    { title: 'Total Silhouette', value: '/images/icons8-pushups-30.png' },
                    { title: 'Abdos Fessiers', value: '/images/icons8-sit-ups-30.png' },
                    { title: 'HIIT', value: '/images/icons8-fitnessBis-30.png' },
                    { title: 'Circuit Training', value: '/images/icons8-girl-running-30.png' },
                    // add more icons here
                  ],
                  layout: 'dropdown'
                },
